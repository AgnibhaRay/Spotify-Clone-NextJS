...
const Player = ({ globalCurrentSongId, setGlobalCurrentSongId, globalIsTrackPlaying, setGlobalIsTrackPlaying }) => {
    ...
    const fetchSongInfo = useCallback(async (trackId) => {
        if (trackId) {
    ...
    useEffect(() => {
        ...
        f()
    }, [globalCurrentSongId, fetchSongInfo, getCurrentlyPlaying, session, setGlobalCurrentSongId, setGlobalIsTrackPlaying]);
